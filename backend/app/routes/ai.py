...
ASSISTANT_ROUTES = {
    ...
    "/code-clinic": "Code Clinic -- post a real coding problem (text/video/image) and get help from other builders",
    "/code-clinic/new": "Form to post a new problem to Code Clinic",
